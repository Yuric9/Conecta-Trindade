          ...
          {step === 2 && (
            <div className="space-y-4 animate-fade-in">
              <div className="flex flex-wrap items-center justify-between gap-2">
                <div>
                  <h2 className="text-lg font-semibold text-[#173b32] mb-1 font-heading">Marque a localização</h2>
                  <p className="text-xs text-gray-500">
                    O mapa é delimitado exclusivamente ao território de <strong>Trindade - GO</strong>.
                  </p>
                </div>
                <div className="flex items-center gap-2">
                  <span className="text-[11px] bg-emerald-50 text-[#006653] font-semibold px-2.5 py-1 rounded-full border border-emerald-200">
                    Limite: Trindade - GO
                  </span>
                  <Button
                    ...
                    variant="outline"
                    size="sm"
                    className="border-[#006653] text-[#006653] hover:bg-emerald-50 h-8 text-xs"
                  >
