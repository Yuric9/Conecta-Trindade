...
function StatusBadge({ status }: { status: string }) {
  ...
  switch (norm) {
    ...
    case 'Em Análise':
      return (
        <Badge variant="outline" className="bg-orange-50 text-orange-900 border-orange-300 font-semibold px-2.5 py-0.5 text-xs gap-1.5 shadow-2xs"><span className="w-2 h-2 rounded-full bg-orange-500"/>{'Em Análise'}</Badge>
      );
    case 'Em Andamento':
      return (
        <Badge
