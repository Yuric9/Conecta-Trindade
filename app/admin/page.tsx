...
export default function AdminPage() {
  ...
  }, [chamados, filterCategoria, filterSecretaria, filterAtrasado, searchTerm]);
      ...
      <div className="max-w-7xl mx-auto px-4 py-6">
        ...
        <div className="flex flex-wrap items-center gap-3 mb-6 bg-white p-3 rounded-xl border border-gray-200 shadow-sm">
          ...
          <div className="relative min-w-[200px] flex-1 max-w-xs">
            ...
            <Input
              type="text"
              placeholder="Buscar protocolo, rua, etc..."
              value={searchTerm}
          ...
          {(filterCategoria !== 'TODAS' || filterSecretaria !== 'TODAS' || filterAtrasado || searchTerm) && (
            <button
              onClick={() => {
          ...
          <span className="text-xs font-medium text-gray-500 ml-auto whitespace-nowrap bg-gray-50 px-2.5 py-1 rounded-full border border-gray-200">
            {filteredChamados.length} de {chamados.length} chamado(s)
          </span>
        </div>
          ...
          <Card className="border-gray-200 overflow-hidden shadow-sm">
            <div className="bg-emerald-950 text-white px-4 py-2.5 flex flex-wrap items-center justify-between gap-2 text-xs">
              <div className="flex items-center gap-2">
                ...
                <span className="text-emerald-300/70 hidden md:inline">| Órgãos Públicos, Escolas, CMEIs, UBS, Parques e Chamados Georreferenciados</span>
              </div>
            ...
            <>
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-start gap-2 p-3 bg-emerald-50 rounded-lg border border-emerald-200">
                  <MapIcon className="w-5 h-5 text-[#006653] mt-0.5 flex-shrink-0" />
                  <div className="text-sm">
                    <p className="text-gray-800 font-medium">{selectedChamado.endereco_texto || 'Sem endereço especificado'}</p>
                    <p className="text-xs text-gray-500 mt-0.5">
                      Coordenadas: {selectedChamado.latitude.toFixed(6)}, {selectedChamado.longitude.toFixed(6)}
                    </p>
                  </div>
                </div>
